...
<head>
    ...
    <title>E-Shopper | Admin | Danh mục</title>
    <style>
    ...
    <div class="container">
        <div class="navigation">
            ...
            <li>
                ...
                <li>
                    <a href="?controller=danhmuc" class="active_admin">
            ...
            <div class="details">
                <div class="recentstaff">
                    <div class="cardHeader">
                        ...
                        <a href="?controller=adddanhmuc" class="btn">Thêm danh mục mới</a>
                    </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="xuly">
                                <a  class="sua" onclick="return confirm('Sửa danh mục này?');" 
                                        href="?controller=xulydanhmuc&method=sua&id=<?php echo $value['id_danhmuc']?>">
                                        <button  class="noselect">
                                            <span class="textsua">Sửa</span>
                                        </button>
                                    </a>
                                    <a  class="xoa" onclick="return confirm('Xóa danh mục này?');" 
                                        href="?controller=xulydanhmuc&method=xoa&id=<?php echo $value['id_danhmuc']?>">
                                        <button  class="noselect">
