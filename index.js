const contentLetterSrart_actived = "\u2B50Nhân ngày sinh nhật chị Đào iu dấu 🎂🥳 em xin được gửi tới chị đôi lời sauuu. Chị ấn vào 🎁 ở dưới đi (rùi chị ấn vào bức thư nhaa😅)" //Lời mở đầu cho bức thư
const mainContentLetter = "Vâng như lời e nói ở đầu ✉️, thì hôm nay là ngày..ngày sinh nhật🎂 của chị Đào🍑 ngày mùng 1 tháng 11 đó. Àaa ừm...cuối cùng cũng đến ngày này, ngày mà em có thể làm và gửi cái này cho chị hihi🤭. Bây giờ e sẽ vào vấn đề chính luôn nà. Bước sang tuổi mới, iem chúc chi iu ngày càng xinh gái hơn, có thiệc nhìu nhìu sức khỏe để luôn đạt được những mục tiêu đặt ra cho công việc cũng như trong cuộc sống nè☘️, luôn luôn vui cười😀, không được buồn rầu😞 nữa này. Vàaa luôn có sức khỏe🏋 để thực hiện những điều trên 1 cách trọn vẹn nhất nhaaa🫡😁. CHÚC MỪNG SINH NHẬT ZUI ZẺ🎉🎉 (hơi nhanh với cả ít nhể:))))" //Nội dung của bức thư
...
document.querySelector("#mess").addEventListener("change", function () { //Hiệu ứng gõ chữ cho phần nội dung của bức thư
    if (this.checked == true) {
        ...
        splitMainContentLetter.forEach((val, index) => {
            setTimeout(() => {
                ...
                if (index == mainContentLetter.length - 1) {
                    document.querySelector(".img1").setAttribute("style", "opacity: 1; transition: .9s")
                }
            }, 50 * index)
        })
        ...
        document.querySelector(".img1").setAttribute("style", "opacity: 0; transition: .9s")
